...
- Implementation and use of rails back end.
- Implementation and use of ruby on rails API file structure.
...
```sh
  git clone https://github.com/EmekaEmmanuel/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/EmekaEmmanuel/hello-rails-back-end/issues).
